package com.vegas.sistema_gestion_operativa.catalog.raw_material.infrastructure.controller;
...
import com.vegas.sistema_gestion_operativa.catalog.raw_material.application.service.RawMaterialService;
...
public class RawMaterialController {
    ...
    public ResponseEntity<PageResponse<RawMaterialResponseDto>> findAll(
            PaginationRequest paginationRequest,
            @RequestParam Long branchId
    ) throws AccessDeniedException {
        Pageable pageable = PaginationUtils.getPageable(paginationRequest);
        Page<RawMaterialResponseDto> rawMaterialPage = rawMaterialService.findAll(
                pageable,
    ...
    public ResponseEntity<RawMaterialResponseDto> delete(
            @PathVariable Long rawMaterialId
    ) throws RawMaterialNotFoundException, AccessDeniedException {
        RawMaterialResponseDto deleted = rawMaterialService.delete(rawMaterialId, AuthUtils.getUserIdFromToken());
