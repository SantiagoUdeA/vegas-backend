...
import com.vegas.sistema_gestion_operativa.reports.infrastructure.builder.IPdfBuilder;
...
public class InventoryMovementsReportService {
    ...
    private final IPdfBuilder pdfBuilder;
    ...
    public byte[] generateProductMovementsReport(GenerateMovementReportDto dto, String userId) throws AccessDeniedException, NoMovementsForReportGenerationException {
        ...
        return report.generatePdf(pdfBuilder, "Reporte de Movimientos de Inventario de Productos");
    }
