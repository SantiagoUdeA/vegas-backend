...
public interface IRawMateriaBatchRepository extends JpaRepository<RawMaterialBatch, Long> {
    ...
    @Query("""
            SELECT new com.vegas.sistema_gestion_operativa.inventory.raw_material.appliaction.dto.RawMaterialBatchDto(
                rmb.id,
                rmb.batchNumber,
                rmb.quantity,
                rm.unitOfMeasure,
            ...
            JOIN com.vegas.sistema_gestion_operativa.catalog.raw_material.domain.entity.RawMaterial rm ON rmb.rawMaterialId = rm.id
